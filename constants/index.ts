...
export const SITE = {
  title: "Goedkope website laten maken vanaf €995 | Sarte Global",
  description:
    "Goedkope website laten maken? Sarte Global bouwt betaalbare én professionele websites voor ondernemers in Nederland — al vanaf €995. Sterke SEO, snelle oplevering en focus op conversie. Vraag vrijblijvend een offerte aan.",
  themeColor: "#0D0D0D",
  brandName: "SARTE GLOBAL",
  brandAccent: ".",
  url: "https://goedkopewebsite-latenmaken.nl",
  name: "Sarte Global",
...
export const TRUST_LINE =
  "Goedkope website laten maken is een dienst van Sarte Global — betaalbaar én professioneel." as const;
...
export const NAV_ITEMS: readonly NavItem[] = [
  { kind: "link", label: "Goedkope website", href: "/" },
...
export const HERO = {
  eyebrow: "Goedkope website laten maken · Sarte Global",
  title: [
    {
      words: [
  ...
  subtitle:
    "Een betaalbare én professionele website voor ondernemers in Nederland — al vanaf €995. Modern design, sterke SEO en snelle oplevering, zonder dat je inlevert op kwaliteit.",
  primaryCta: { label: "Goedkope website aanvragen", href: "#cta" },
  secondaryCta: { label: "Bekijk portfolio", href: "/work" },
  pricingCta: { label: "Bekijk de prijzen", href: "#pakketten" },
  stats: [
    { label: "Betaalbaar vanaf €995" },
    { label: "Binnen 2 weken online" },
    { label: "Voor MKB & ondernemers" },
  ],
  scrollLabel: "Scroll",
  badgeText:
    "GOEDKOPE WEBSITE LATEN MAKEN · SARTE GLOBAL · BETAALBAAR & PROFESSIONEEL · SARTE GLOBAL · ",
...
export const CTA_SECTION = {
  titleLead: "Laat jouw betaalbare website",
  titleEm: "vandaag starten.",
  sub: "Plan een gratis kennismaking van 30 minuten — geen verplichtingen, gewoon een open gesprek over jouw website, budget en doelen.",
  ctaLabel: "Neem contact op",
  ctaHref: "mailto:info@sarteglobal.com",
} as const;

export const FOOTER_MISSION =
  "Betaalbare én professionele websites voor ondernemers en bedrijven in Nederland — al vanaf €995. Een dienst van Sarte Global, gebouwd voor groei en gemaakt om te verkopen." as const;
