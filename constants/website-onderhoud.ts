...
export const ONDERHOUD_META = {
  ...
  title: "Website onderhoud vanaf €79 per maand | Sarte Global",
  description:
    "Website onderhoud vanaf €79 per maand waardoor je site veilig, snel en up-to-date blijft. Updates, beveiliging, dagelijkse back-ups, monitoring en doorlopende verbeteringen — zonder zorgen. Vraag een vrijblijvend onderhoudsplan aan.",
  keywords: [
    "website onderhoud",
    "wordpress onderhoud",
