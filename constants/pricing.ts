 ...
 * have no fixed list price use `amount: null` → "Op aanvraag". Positionering is
 * "betaalbaar én professioneel": de prijzen dienen als bewijs van betaalbaarheid
 * (bv. "vanaf €995"), zonder de kwaliteit/uitstraling te ondermijnen — dus geen
 * "laagste prijs"/"goedkoopste" race-to-the-bottom-taal in de tiers zelf.
 */
