...
export const LANDING_HERO = {
  eyebrow: "Website laten maken · Sarte Global",
  badge: "Nu beschikbaar voor 3 nieuwe projecten",
  titleLead: "Betaalbare website laten maken voor",
  titleEm: "meer groei en klanten.",
  sub: "Sarte Global ontwikkelt betaalbare, professionele en responsive websites voor ondernemers en bedrijven in Nederland — al vanaf €995. Modern design, sterke SEO en een opbouw die bezoekers omzet in klanten.",
...
export const LANDING_MEANING = {
  ...
  title: "Wat betekent een goedkope website laten maken?",
  paragraphs: [
...
export const LANDING_PROCESS = [
  {
    ...
    title: "Analyse",
    description:
      "We brengen jouw bedrijf, doelgroep en doelen in kaart en bekijken wat de concurrentie doet. Zo weten we precies wat jouw website nodig heeft — en houden we de scope (en prijs) scherp.",
  },
  {
    number: "02",
    title: "Strategie",
  ...
  },
  {
    ...
    title: "Lancering",
    description:
      "We zetten je website live, regelen hosting en blijven beschikbaar voor onderhoud, updates en verdere optimalisatie.",
  },
...
export const LANDING_FAQ = [
  {
    ...
    answer:
      "Een professionele website laten maken begint bij Sarte Global vanaf €995 voor een one-pager, terwijl een complete zakelijke website met CMS rond €1.995 ligt en maatwerk oploopt richting €3.495. De prijs volgt de scope: je betaalt alleen voor wat je nodig hebt. Je ontvangt altijd vooraf een heldere offerte, zonder verrassingen achteraf.",
  },
  {
    question: "Is een goedkope website wel professioneel?",
    answer:
      "Zeker. Goedkoop betekent bij ons efficiënt, niet minder kwaliteit. Doordat we met een vast team en een bewezen, modern fundament werken, houden we de uren — en dus de prijs — laag, zonder af te dingen op design, snelheid of SEO. Je krijgt de prijs van een goedkope website met de uitstraling van een professioneel bureau.",
  },
  {
    question: "Wordt mijn website goed vindbaar in Google?",
    answer:
      "Ja. Elke website bouwen we met sterke technische SEO als basis: een nette structuur, snelle laadtijden, schema-markup en doordachte metadata. Daardoor is je website vindbaar vanaf dag één. Voor structurele groei kunnen we je ook helpen met content en doorlopende SEO-optimalisatie.",
  },
  {
...
export const LANDING_CTA = {
  ...
  titleEm: "betaalbare website.",
  sub: "Vertel ons kort over jouw bedrijf en doelen. Je ontvangt binnen één werkdag een vrijblijvende offerte voor jouw website — al vanaf €995.",
...
export const LANDING_WHY = {
  ...
  lead: "Geen losse freelancers of doorverkochte uren. Bij Sarte Global werkt één senior team aan jouw website — van het eerste strategiegesprek tot ruim na de livegang. Die efficiënte aanpak houdt de prijs laag én de kwaliteit hoog. We werken voor ondernemers door heel Nederland, van Amsterdam en Rotterdam tot Utrecht, Eindhoven en Den Haag.",
  media: {
...
export const LANDING_FEATURES_SECTION = {
  ...
  titleEm: "nodig heeft.",
  sub: "Kies een onderdeel en zie wat het voor jouw bezoekers betekent. Standaard inbegrepen bij elke website — ook in het betaalbare instappakket.",
} as const;
...
export const LANDING_INSPIRATION_SECTION = {
  ...
  ctaLabel: "Goedkope website laten maken",
} as const;
...
export const LANDING_TESTIMONIALS_SECTION = {
  ...
  titleEm: "aanbevelen.",
  sub: "Echte ervaringen van bedrijven die hun website betaalbaar door Sarte Global lieten maken.",
  score: "4,9",
...
export const LANDING_FINAL_CTA = {
  ...
  titleLead: "Jouw betaalbare website",
  titleEm: "begint vandaag.",
  sub: "Vertel ons kort over je bedrijf, budget en doelen. Binnen één werkdag ontvang je een vrijblijvende offerte — helder, op maat en zonder verplichtingen.",
