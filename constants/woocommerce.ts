...
export const WOOCOMMERCE_META = {
  ...
  title: "WooCommerce webshop laten maken vanaf €1.995 | Sarte Global",
  description:
    "WooCommerce webshop laten maken door specialisten — betaalbaar vanaf €1.995. Een snelle, schaalbare webshop op WordPress, volledig van jou en zonder transactiekosten van het platform. iDEAL en alle betaalmethoden. Vraag vrijblijvend een offerte aan.",
  keywords: [
