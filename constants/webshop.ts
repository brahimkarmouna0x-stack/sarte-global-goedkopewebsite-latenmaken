...
export const WEBSHOP_META = {
  ...
  title: "Webshop laten maken vanaf €1.995 | Betaalbaar - Sarte Global",
  description:
    "Webshop laten maken die verkoopt — betaalbaar én professioneel, al vanaf €1.995. Een snelle, conversiegerichte webshop met iDEAL en alle betaalmethoden, mobiel afrekenen en sterke SEO. Vraag vrijblijvend een offerte aan.",
  keywords: [
    "webshop laten maken",
