...
export const WEBAPP_META = {
  ...
  title: "Webapp laten maken | Betaalbaar maatwerk - Sarte Global",
  description:
    "Webapp laten maken op maat zonder onnodige kosten: start betaalbaar met een MVP en groei gefaseerd. SaaS, dashboards, klantportalen en interne tools op een moderne, schaalbare stack (Next.js & React). Vraag vrijblijvend een offerte aan.",
  keywords: [
    "webapp laten maken",
