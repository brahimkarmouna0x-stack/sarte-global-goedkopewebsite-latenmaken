...
export const SEO_META = {
  ...
  title: "SEO optimalisatie vanaf €299 per maand | Sarte Global",
  description:
    "SEO optimalisatie met een eerlijk maandtarief vanaf €299 — structureel meer bezoekers en klanten. Technische SEO, sterke content, lokale SEO en heldere rapportage voor ondernemers in Nederland. Vraag een vrijblijvende SEO-analyse aan.",
  keywords: [
    "seo optimalisatie",
    "seo specialist",
