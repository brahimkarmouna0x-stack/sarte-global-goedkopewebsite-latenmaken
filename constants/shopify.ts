...
export const SHOPIFY_META = {
  ...
  title: "Shopify webshop laten maken | Betaalbaar & professioneel - Sarte Global",
  description:
    "Shopify webshop laten maken door specialisten — betaalbaar én professioneel. Een snelle, betrouwbare en schaalbare webshop met maatwerk Shopify-thema. iDEAL en alle betaalmethoden, weinig onderhoud en sterke conversie. Vraag vrijblijvend een offerte aan.",
  keywords: [
