...
export const NEXTJS_META = {
  ...
  title: "Next.js website laten maken | Snel & betaalbaar - Sarte Global",
  description:
    "Next.js website laten maken voor maximale snelheid en topscores op Core Web Vitals — premium prestaties tegen een betaalbare prijs. Een razendsnelle, schaalbare en SEO-sterke website op de modernste React-techniek. Vraag vrijblijvend een offerte aan.",
  keywords: [
