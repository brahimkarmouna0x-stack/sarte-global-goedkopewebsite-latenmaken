...
export const WORDPRESS_META = {
  ...
  title: "WordPress website laten maken vanaf €995 | Sarte Global",
  description:
    "WordPress website laten maken door een specialist — betaalbaar én professioneel, al vanaf €995. Maatwerk thema's, sterke SEO en een website die je zelf eenvoudig beheert. Vraag vrijblijvend een offerte aan.",
  keywords: [
