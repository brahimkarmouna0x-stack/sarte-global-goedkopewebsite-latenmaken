...
export const LANDINGPAGE_META = {
  ...
  title: "Landing page laten maken | Betaalbaar & conversiegericht - Sarte Global",
  description:
    "Landing page laten maken die bezoekers omzet in leads en klanten — betaalbaar en met maximaal rendement op je advertentiebudget. Eén doel, een snelle conversiegerichte pagina met sterke koppen, heldere CTA's en A/B-testen. Vraag vrijblijvend een offerte aan.",
  keywords: [
