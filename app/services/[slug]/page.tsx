...
import { getPageSeo, SERVICE_FAQ, SERVICE_LANDING_PAGE_BY_SLUG, SERVICES, SITE } from "@/constants";
...
export default async function ServicePage({ params }: ServicePageProps) {
  ...
  // Unieke 3 SEO-secties bestaan alleen voor de indexeerbare /services/[slug]
  // pagina's (de keyword-twins redirecten weg), dus conditioneel renderen.
  ...
  return (
    <main className="service-page" id="top">
      ...
      {/* 3 verplichte SEO-secties (alleen voor indexeerbare service-pagina's) */}
      {seo && <PageSeoSections content={seo} idPrefix={`svc-${slug}`} />}
