...
const PAGE_DESC =
  "Ontdek alle diensten van Sarte Global: een betaalbare website of webshop laten maken, landingspagina's, SEO, UX/UI-design, mobiele apps en online advertising — één partner voor digitale groei.";
...
const HERO = {
  ...
  intro:
    "Van een betaalbare website of webshop laten maken tot SEO, UX/UI-design en online advertising. Bekijk wat Sarte Global voor jouw bedrijf kan betekenen.",
