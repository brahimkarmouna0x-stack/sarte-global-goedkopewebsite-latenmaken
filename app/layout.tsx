...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "voordelige website laten maken",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 800,
        alt: "Sarte Global — Goedkope website laten maken vanaf €995",
      },
    ],
  },
  twitter: {
...
function buildOrganizationJsonLd(settings: SiteSettings) {
  ...
  return {
    ...
    legalName: "Sarte Global",
    url: SITE_URL,
    logo: `${SITE_URL}/images/company-img.png`,
    image: `${SITE_URL}/images/company-img.png`,
    description:
      "Sarte Global maakt betaalbare én professionele websites voor ondernemers en bedrijven in Nederland — al vanaf €995. Modern design, sterke SEO, snelle oplevering en focus op resultaat.",
    slogan: "Betaalbare, professionele websites voor ondernemers in Nederland — al vanaf €995.",
    priceRange: "€€",
...
const SERVICE_JSON_LD = {
  ...
  name: SERVICE_NAME,
  serviceType: "Goedkope website laten maken",
  ...
  offers: {
    ...
    priceCurrency: "EUR",
    price: "995",
    description: "Betaalbare, professionele website laten maken — vanaf €995.",
    availability: "https://schema.org/InStock",
  },
  description:
    "Goedkope website laten maken voor ondernemers en bedrijven in Nederland — al vanaf €995. Betaalbare, professionele en responsive websites met sterke SEO, snelle oplevering en focus op conversie.",
};
