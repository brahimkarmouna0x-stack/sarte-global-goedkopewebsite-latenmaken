...
const PAGE_DESC =
  "Sarte Global is het bureau achter goedkopewebsite-latenmaken. We bouwen betaalbare én professionele websites voor ondernemers en bedrijven in Nederland — al vanaf €995.";
...
export default function OverOnsPage() {
  return (
    <main className="about-page" id="top">
      ...
      <PageSeoSections content={PAGE_SEO["over-ons"]} idPrefix="about" />
      <CallToAction />
    </main>
  );
}
