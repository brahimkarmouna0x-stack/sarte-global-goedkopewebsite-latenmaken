...
1. Add & verify the property (DNS or HTML tag) for `https://goedkopewebsite-latenmaken.nl`.
2. Submit `https://goedkopewebsite-latenmaken.nl/sitemap.xml` under **Sitemaps**.
